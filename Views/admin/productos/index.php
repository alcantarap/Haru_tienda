        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover align-midle" style="width: 100%;" id="tblProductos">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nombre</th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group mb-2">
                                ...
                                <input id="nombre" class="form-control" type="text" name="nombre" placeholder="Nombre Producto">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group mb-2">
